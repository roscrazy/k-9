 ...
 */
public class AccountSetupBasics1 extends K9Activity
    ...
    public static void actionNewAccount(Context context) {
        Intent i = new Intent(context, AccountSetupBasics1.class);
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        switch (v.getId()) {
            case R.id.edt_apple_id:
                if (hasFocus) {
                    mIdLine.setBackgroundResource(R.color.light_cyan);
                    mPasswordLine.setBackgroundResource(R.color.gray);
                } else {
                    mIdLine.setBackgroundResource(R.color.gray);
                    mPasswordLine.setBackgroundResource(R.color.light_cyan);
                }
                break;
